...
color_dict={3: (200, 55, 65), 0: (220, 220, 220), 2: (217, 219, 215), 4: (214, 218, 210), 8: (211, 217, 205), 16: (208, 216, 200), 32: (205, 215, 195), 64: (202, 214, 190), 128: (199, 213, 185), 256: (196, 212, 180), 512: (193, 211, 175), 1024: (190, 210, 170), 2048: (187, 209, 165), 4096: (184, 208, 160), 8192: (181, 207, 155), 16384: (178, 206, 150)}
        ...
        for i in range(self.row_num):
            for j in range(self.row_num):
                if self.data[i][j] in color_dict.keys():
                    self._show_part(
                        (self.center[0]-self.size[0]//2+self.size[0]*(2*j+1)//self.row_num//2,self.center[1]-self.size[1]//2+self.size[1]*(2*i+1)//self.row_num//2)
                        ,self.data[i][j]
