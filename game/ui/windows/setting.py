...
class Setting(Window):
    def __init__(self, config: toml):
        ...
        self.input_box_list=Input_box_list([self.online_ip_input_box,self.online_port_input_box, self.goal_input_box,])
    ...
    def onclick(self, mouse_pos: (int, int)):
        ...
        if self.goal_input_box or self.online_ip_input_box or self.online_port_input_box in onclick_list :
